...
for id in id_list:
	...
	if "chrblood_bc1vol" in sub_data_baseline and not sub_data_baseline.empty:
		bc_1 = sub_data_baseline.at[0, "chrblood_bc1vol"]
	if "chrblood_bc1vol" in sub_data_month2 and not sub_data_month2.empty:
		bc_1_m2 = sub_data_month2.at[0, "chrblood_bc1vol"]
	if "chrblood_wb1vol" in sub_data_baseline and not sub_data_baseline.empty:
		wb_1 = sub_data_baseline.at[0, "chrblood_wb1vol"]
	if "chrblood_wb1vol" in sub_data_month2 and not sub_data_month2.empty:
		wb_1_m2 = sub_data_month2.at[0, "chrblood_wb1vol"]
	if "chrblood_wb2vol" in sub_data_baseline and not sub_data_baseline.empty:
		wb_2 = sub_data_baseline.at[0, "chrblood_wb2vol"]
	if "chrblood_wb2vol" in sub_data_month2 and not sub_data_month2.empty:
		wb_2_m2 = sub_data_month2.at[0, "chrblood_wb2vol"]
	if "chrblood_wb3vol" in sub_data_baseline and not sub_data_baseline.empty:	
		wb_3 = sub_data_baseline.at[0, "chrblood_wb3vol"]
	if "chrblood_wb3vol" in sub_data_month2 and not sub_data_month2.empty:
		wb_3_m2 = sub_data_month2.at[0, "chrblood_wb3vol"]

	if "chrblood_se1vol" in sub_data_baseline and not sub_data_baseline.empty:
		sr_1 = sub_data_baseline.at[0, "chrblood_se1vol"]
	if "chrblood_se1vol" in sub_data_month2 and not sub_data_month2.empty:
		sr_1_m2 = sub_data_month2.at[0, "chrblood_se1vol"]
	if "chrblood_se2vol" in sub_data_baseline and not sub_data_baseline.empty:
		sr_2 = sub_data_baseline.at[0, "chrblood_se2vol"]
	if "chrblood_se2vol" in sub_data_month2 and not sub_data_month2.empty:
		sr_2_m2 = sub_data_month2.at[0, "chrblood_se2vol"]
	if "chrblood_se3vol" in sub_data_baseline and not sub_data_baseline.empty:
		sr_3 = sub_data_baseline.at[0, "chrblood_se3vol"]
	if "chrblood_se3vol" in sub_data_month2 and not sub_data_month2.empty:
		sr_3_m2 = sub_data_month2.at[0, "chrblood_se3vol"]

	if "chrblood_pl1vol" in sub_data_baseline and not sub_data_baseline.empty:
		pl_1 = sub_data_baseline.at[0, "chrblood_pl1vol"]
	if "chrblood_pl1vol" in sub_data_month2 and not sub_data_month2.empty:
		pl_1_m2 = sub_data_month2.at[0, "chrblood_pl1vol"]
	if "chrblood_pl2vol" in sub_data_baseline and not sub_data_baseline.empty:
		pl_2 = sub_data_baseline.at[0, "chrblood_pl2vol"]
	if "chrblood_pl2vol" in sub_data_month2 and not sub_data_month2.empty:
		pl_2_m2 = sub_data_month2.at[0, "chrblood_pl2vol"]
	if "chrblood_pl3vol" in sub_data_baseline and not sub_data_baseline.empty:
		pl_3 = sub_data_baseline.at[0, "chrblood_pl3vol"]
	if "chrblood_pl3vol" in sub_data_month2 and not sub_data_month2.empty:
		pl_3_m2 = sub_data_month2.at[0, "chrblood_pl3vol"]
	if "chrblood_pl4vol" in sub_data_baseline and not sub_data_baseline.empty:
		pl_4 = sub_data_baseline.at[0, "chrblood_pl4vol"]
	if "chrblood_pl4vol" in sub_data_month2 and not sub_data_month2.empty:
		pl_4_m2 = sub_data_month2.at[0, "chrblood_pl4vol"]
	if "chrblood_pl5vol" in sub_data_baseline and not sub_data_baseline.empty:
		pl_5 = sub_data_baseline.at[0, "chrblood_pl5vol"]
	if "chrblood_pl5vol" in sub_data_month2 and not sub_data_month2.empty:
		pl_5_m2 = sub_data_month2.at[0, "chrblood_pl5vol"]
	if "chrblood_pl6vol" in sub_data_baseline and not sub_data_baseline.empty:
		pl_6 = sub_data_baseline.at[0, "chrblood_pl6vol"]
	if "chrblood_pl6vol" in sub_data_month2 and not sub_data_month2.empty:
	...
	if "chrsaliva_vol1a" in sub_data_baseline and not sub_data_baseline.empty:
		s_1 = sub_data_baseline.at[0, "chrsaliva_vol1a"]
	if "chrsaliva_vol1a" in sub_data_month2 and not sub_data_month2.empty:
		s_1_m2 = sub_data_month2.at[0, "chrsaliva_vol1a"]
	if "chrsaliva_vol1b" in sub_data_baseline and not sub_data_baseline.empty:
		s_2 = sub_data_baseline.at[0, "chrsaliva_vol1b"]
	if "chrsaliva_vol1b" in sub_data_month2 and not sub_data_month2.empty:
		s_2_m2 = sub_data_month2.at[0, "chrsaliva_vol1b"]
	if "chrsaliva_vol2a" in sub_data_baseline and not sub_data_baseline.empty:
		s_3 = sub_data_baseline.at[0, "chrsaliva_vol2a"]
	if "chrsaliva_vol2a" in sub_data_month2 and not sub_data_month2.empty:
		s_3_m2 = sub_data_month2.at[0, "chrsaliva_vol2a"]
	if "chrsaliva_vol2b" in sub_data_baseline  and not sub_data_baseline.empty:
		s_4 = sub_data_baseline.at[0, "chrsaliva_vol2b"]
	if "chrsaliva_vol2b" in sub_data_month2 and not sub_data_month2.empty:
		s_4_m2 = sub_data_month2.at[0, "chrsaliva_vol2b"]
	if "chrsaliva_vol3a" in sub_data_baseline and not sub_data_baseline.empty:
		s_5 = sub_data_baseline.at[0, "chrsaliva_vol3a"]
	if "chrsaliva_vol3a" in sub_data_month2 and not sub_data_month2.empty:
		s_5_m2 = sub_data_month2.at[0, "chrsaliva_vol3a"]
	if "chrsaliva_vol3b" in sub_data_baseline and not sub_data_baseline.empty:
		s_6 = sub_data_baseline.at[0, "chrsaliva_vol3b"]
	if "chrsaliva_vol3b" in sub_data_month2 and not sub_data_month2.empty:
...
############ Missing variables for clinical data
  ...
  # baseline
	...
	if os.path.exists(percentage_file):
		...
		if baseline != [] and baseline in percentages.index:
		...
		if conversion != [] and conversion in percentages.index:
...
for vi in ["month1", "month2", "month3", "month4", "month5", "month6", "month7", "month8"]:
	...
	file_name = "combined-{0}-form_{1}-day1to1.csv".format(network, vi)
