...
for col in cols:
	...
	if '_tot' in col:
		...
		template2['analysis']= 'forms_qc'
		template2['variable']= col
		template2['label']="Total variables"
		template2['category']=category
		dict1['config'].append(template2)
	...
	if '_date' in col:
		...
		template2['analysis']= 'forms_qc'
		template2['variable']= col
		template2['label']="Time between interview & entry"
		template2['category']=category
		dict1['config'].append(template2)	
	...
	if '_miss' in col:
		...
		template2['analysis']= 'forms_qc'
		template2['variable']= col
		template2['label']="Missing specifications"
		template2['category']=category
		dict1['config'].append(template2)
...
with open('formqc-5.json','w') as f:
