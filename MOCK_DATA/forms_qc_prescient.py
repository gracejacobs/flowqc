...
# saving the csv
dpdash_full.to_csv(output_path+site+"-"+id+"-forms_qc-day1to"+day+".csv", sep=',', index = False, header=True)

dpdash_full.to_csv("/data/pnl/home/gj936/U24/Clinical_qc/flowqc/MOCK_DATA/Prescient_status/"+site+'-'+id+"-forms_qc-day1to"+day+".csv", sep=',', index = False, header=True)
